...
class CategoryFixture extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->addReference(self::CATEGORY_NAME_GRAB, $grab);
        $this->addReference(self::CATEGORY_NAME_ROTATION, $rotation);
        $this->addReference(self::CATEGORY_NAME_FLIP, $flip);
        $this->addReference(self::CATEGORY_NAME_SLIDES, $slide);
    }
