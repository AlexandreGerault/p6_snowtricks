...
{
    public function __construct(private readonly MailerInterface $mailer, private LoginLinkHandlerInterface $loginLinkHandler, private UserRepository $repository)
    {
    }
